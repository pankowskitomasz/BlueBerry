...
<html lang="en">
    ...
    <body>
        ...
        <section class="container-fluid error-s1 d-flex max-600 minh-50vh">
        ...
        <section class="container-fluid error-s2 d-flex bg-light minh-50vh" id="message">
                ...
                <div class="col-12 col-sm-6 p-3 text-white text-center text-sm-left">
                    <div class="float-sm-right float-none">
                        ...
                        <div class="list-group pl-sm-3">
                            ...
                            <a href="treats.html" class="text-white">
                                <small>The treats</small>
                            </a>
                            <a href="menu.html" class="text-white">
                                <small>Menu</small>
                            </a>
